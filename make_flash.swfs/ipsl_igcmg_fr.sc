.flash filename="ipsl_igcmg_fr.swf" version=6 compress background=#FFFFFF
...
.text logotitle5 font=myfont1 text="Sciences de" size=32% color=black
.put logotitle5 x=105 y=90

.text logotitle6 font=myfont1 text="l'Environnement" size=32% color=black
.put logotitle6 x=105 y=120

# French characters in UTF-8 (hex) (a confirmer avec prochaine version CVS)
# à=\xE0 è=\xE8 é=\xE9

.text text_author_1 font=myfont2 text="IGCMG - IPSL Groupe Climat" color=black size=32%
.put text_author_1 pin=center x=280 y=240

.text text_author_2 font=myfont2 text="et Mod\xe9lisation Globale" color=black size=32%
