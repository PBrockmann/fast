...
for file in `ls -1 $dir1/*` ; do
	...
	convert -transparent white -crop 490x490+140+90 +repage $dir1/$file1 $dir3/tmp1.gif
	convert -transparent white -crop 490x490+140+90 +repage $dir2/$file1 $dir3/tmp2.gif

	# resize	
	convert -geometry 420x420 $dir3/tmp1.gif $dir3/ok1.png
	convert -geometry 420x420 $dir3/tmp2.gif $dir3/ok2.png
